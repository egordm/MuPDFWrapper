...
public class ColorDialog implements View.OnTouchListener, PopupWindow.OnDismissListener {
	...
	public void show()
	{
		...
		//  set the title
		TextView tv = popupView.findViewById(R.id.color_dialog_title);
		if (mShowTitle) {
		...
		rows[0] = popupView.findViewById(R.id.fontcolors_row1);
		rows[1] = popupView.findViewById(R.id.fontcolors_row2);
		rows[2] = popupView.findViewById(R.id.fontcolors_row3);
		...
		Button tpb = popupView.findViewById(R.id.transparent_color_button);

...
public class DocPageView extends View implements Callback
{
	...
	private class RenderTask extends AsyncTask<RenderTaskParams, Void, Void>
	{
		...
		{
			params = paramList[0];
			//TODO: WARNING WARNING apparently they changed this. Note the negative params.pageX0 and params.pageY0
			AndroidDrawDevice dev = new AndroidDrawDevice(params.bitmap, -params.pageX0, -params.pageY0, params.patchX0, params.patchY0, params.patchX1, params.patchY1);
			try
			{
				Cookie cookie = new Cookie();
				if (pageContents != null)

...
public class ProofActivity extends Activity implements View.OnClickListener, DocViewBase.IdleRenderListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mDocView = findViewById(R.id.proof_view);
		
		mFirstPageButton = findViewById(R.id.proof_first_page);
		mFirstPageButton.setOnClickListener(this);
		
		mPreviousPageButton = findViewById(R.id.proof_previous_page);
		mPreviousPageButton.setOnClickListener(this);
		
		mNextPageButton = findViewById(R.id.proof_next_page);
		mNextPageButton.setOnClickListener(this);
		
		mLastPageButton = findViewById(R.id.proof_last_page);
		mLastPageButton.setOnClickListener(this);
		
		mBackButton = findViewById(R.id.proof_back_button);
		mBackButton.setOnClickListener(this);
		
		mColorsUpButton = findViewById(R.id.proof_colors_button_up);
		mColorsUpButton.setOnClickListener(this);
		
		mColorsDownButton = findViewById(R.id.proof_colors_button_down);
		mColorsDownButton.setOnClickListener(this);
		
		mApplyButton = findViewById(R.id.proof_apply_button);
	...
	private void setPageLabel() {
		...
		TextView tv = findViewById(R.id.proof_page_n_of_n);
		tv.setText(s);
	}
	...
	public void onIdle() {
		...
		if (mWaitingForIdle) {
			...
			//  set up the list
			mColorList = findViewById(R.id.proof_color_list);
